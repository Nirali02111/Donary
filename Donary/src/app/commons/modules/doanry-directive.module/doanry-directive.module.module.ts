...
@NgModule({
  declarations: [AddressAutocompleteDirective, FilterDataPipe, JoinAndUpperCasePipe, HoverTooltipDirective, DataHoverDirective, IsMobileDirective, IsWebDirective, ClickOutsideDirective],
  imports: [CommonModule],
  exports: [AddressAutocompleteDirective, FilterDataPipe, JoinAndUpperCasePipe, HoverTooltipDirective, DataHoverDirective, IsMobileDirective, IsWebDirective, ClickOutsideDirective],
  providers: [BROWSER_GLOBALS_PROVIDERS, GoogleMapService, FilterDataPipe, JoinAndUpperCasePipe],
})
