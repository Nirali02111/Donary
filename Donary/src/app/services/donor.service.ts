...
export class DonorService {
    ...
    BulkInactiveDonor(formdata: any): Observable<any> {
      return this.http.post(this.DONOR_BULKINACTIVE_URL, formdata).pipe(response => {
        return response;
      });
    }

    SaveDonorEmail(formdata: any): Observable<any> {
      return this.http.post(this.DONOR_SAVEEMAIL_URL, formdata).pipe(response => {
      return response;
        });
      }

    SaveDonorPhone(formdata: any): Observable<any> {
      return this.http.post(this.DONOR_SAVEPHONE_URL, formdata).pipe(response => {
      return response;
        });
      }
    getDonorById(eventGuid: string, accountId: Int32Array,isGLobal:boolean=false) {
      return this.http.get(this.DONOR_GET_URL + '?eventGuid=' + eventGuid + "&&accountId=" + accountId+ "&&isGlobal=" + isGLobal ).pipe(response => {
      return response;
        });
     }

    getDonorEmailList(eventGuid: string, accountId: Int32Array) {
      return this.http.get(this.DONOR_GETEMAILLIST_URL + '?eventGuid=' + eventGuid + "&&accountId=" + accountId).pipe(response => {
      return response;
      });
     }

     getDefaultWallet(formData:any) {
      return this.http.post(this.GET_DEFAULT_WALLETS,formData).pipe(response => {
      return response;
      });
     }

    getDonorPhoneList(eventGuid: string, accountId: Int32Array) {
    return this.http.get(this.DONOR_GETPHONELIST_URL + '?eventGuid=' + eventGuid + "&&accountId=" + accountId).pipe(response => {
    return response;
    });
     }

    getEmailByAccountEmailId(eventGuid: string, accountEmailID: Int32Array,loginUserId: Int32Array) {
    return this.http.get(this.DONOR_GETACCOUNTEMAIL_URL + '?eventGuid=' + eventGuid + "&&accountEmailID=" + accountEmailID + "&&loginUserId=" + loginUserId,this.httpOptions).pipe(response => {
    return response;
  });
    }

    getPhoneByAccountPhoneId(eventGuid: string, accountPhoneID: Int32Array,loginUserId: Int32Array) {
     return this.http.get(this.DONOR_GETACCOUNTPHONE_URL + '?eventGuid=' + eventGuid + "&&accountPhoneID=" + accountPhoneID + "&&loginUserId=" + loginUserId,this.httpOptions).pipe(response => {
      return response;
  });
    }

    deleteDonorEmail(eventGuid: string, accountEmailIds: Int32Array,loginUserId: Int32Array) {
    return this.http.delete(this.DONOR_DELETEEMAIL_URL + '?eventGuid=' + eventGuid + "&&accountEmailIds=" + accountEmailIds + "&&loginUserId=" + loginUserId,this.httpOptions).pipe(response => {
    return response;
  });
    }


    deleteDonorPhone(eventGuid: string, accountPhoneID: Int32Array,loginUserId: Int32Array) {
    return this.http.delete(this.DONOR_DELETEPHONE_URL + '?eventGuid=' + eventGuid + "&&accountPhoneID=" + accountPhoneID + "&&loginUserId=" + loginUserId,this.httpOptions).pipe(response => {
    return response;
  });

    }
    deleteDonor(formdata:any) {
      return this.http.request('delete', this.DONOR_DELETE_URL, { body: formdata }).pipe(response => {
        return response;
      });
  }

  deleteDonorLocation(accountLocationId:Int32Array) {
    return this.http.delete(this.DELETE_DONORLOCATION_URL + '?accountLocationId=' + accountLocationId ,this.httpOptions).pipe(response => {
      return response;
    });
  }
  getReportByDonor(formData: any){
    return this.http.post(this.DONOR_REPORTBYDONOR_URL, formData ).pipe(response =>{
      return response;
    });

  }
  getReportByDate(event:any){
    return this.http.post(this.DONOR_REPORTBYDATE_URL ,event).pipe(response => {
      return response;
    })
  ...
  //Wallet Methods
    ...
    return this.http.post(this.DONOR_SAVEWALLET_URL, formdata).pipe(response => {
    return response;
  });
    }
    getWalletByAccountId(eventGuid: string, accountId: Number) {
      return this.http.get(this.DONOR_GETWALLETBYACCOUNTID_URL + '?eventGuid=' + eventGuid + "&&accountId=" + accountId).pipe(response => {
       return response;
  });
    }
    getWalletById(eventGuid: string, walletId: Int32Array) {
      return this.http.get(this.DONOR_GETWALLETBYID_URL + '?eventGuid=' + eventGuid + "&&walletId=" + walletId).pipe(response => {
       return response;
  });
    }
    deleteDonorWallet(eventGuid: string, updatedBy: Int32Array,walletId: Int32Array) {
      return this.http.delete(this.DONOR_DELETEWALLET_URL + '?eventGuid=' + eventGuid + "&&updatedBy=" + updatedBy + "&&walletId=" + walletId,this.httpOptions).pipe(response => {
      return response;
    });
    }
    ...
    getMergeDonors(eventGuid){
      return this.http.get(this.DONOR_GET_MERGE_URL, { params:{ eventGuid }}).pipe(response => {
        return response;
      });
    }
    ...
    getDonorCityStateZip(eventGuid) {
      return this.http.get(this.DONOR_GET_CITY_STATE_ZIP_URL + '?eventGuid=' + eventGuid).pipe(response => {
        return response
      });
    }
    ...
    getDonorColumns(formData) {
      return this.http.post(this.DONOR_GET_COLUMN_URL, formData).pipe(response => {
        return response
      });
    }

    getDonorLabels(formData) {
      return this.http.post(this.DONOR_GET_LABEL_URL, formData).pipe(response => {
        return response
      });
    }
    ...
    getDonarsReport(formData){
     ...
     deleteMultipleDonorEmail(eventGuid: string, accountEmailIds: string,loginUserId: Int32Array) {
      return this.http.delete(this.DONOR_DELETEEMAIL_URL + '?eventGuid=' + eventGuid + accountEmailIds + "&&loginUserId=" + loginUserId,this.httpOptions).pipe(response => {
      return response;
    });
      }
    ...
    // });
    //   }
    deleteMultipleDonorAddress(accountAddressIds: string, loginUserId: Int32Array,eventGuid: string,macAddress:string) {
      return this.http.delete(this.DONOR_DELETEADDRESS_URL + "?" + accountAddressIds  + "&&loginUserId=" + loginUserId + '&&eventGuid=' + eventGuid + '&&macAddress='+ macAddress,this.httpOptions).pipe(response => {
      return response;
    });
      }
      deleteMultipleDonorPhone(eventGuid: string, accountPhoneIds: string,loginUserId: Int32Array) {
        return this.http.delete(this.DONOR_DELETEPHONE_URL + '?eventGuid=' + eventGuid  + accountPhoneIds + "&&loginUserId=" + loginUserId,this.httpOptions).pipe(response => {
        return response;
      });
    }
    ...
    donarImport(formData){
     ...
     downloadDonarTemplate():Observable<any>{
      return this.http.get(this.DONOR_DOWNLOAD_TEMPLATE,{ responseType: "blob" }
        ).pipe(
        response=>{
    ...
    deleteDonorAddress(accountAddressId: string, loginUserId: Int32Array,eventGuid: string,macAddress:string) {
      return this.http.delete(this.DONOR_DELETEADDRESS_URL + "?accountAddressId=" + accountAddressId  + "&&loginUserId=" + loginUserId + '&&eventGuid=' + eventGuid + '&&macAddress='+ macAddress,this.httpOptions).pipe(response => {
        return response;
      });
    }
    downloadTokenTemplate():Observable<any>{
      return this.http.get(this.DONOR_TOKEN_DOWNLOAD_TEMPLATE,{ responseType: "blob" }
        ).pipe(
        response=>{
          console.log(response);
          return response
    ...
    GetOpenStatements(formData){
      return this.http.post(this.GET_OPEN_STATEMENTS, formData).pipe(response => {
        return response
      });
    }
}